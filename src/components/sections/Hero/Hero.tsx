        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mb-20">
            <MagneticButton className="w-full sm:w-auto">
              <a href="/resume/Anandhu_Jayan_Resume.pdf" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto flex items-center justify-center gap-2 px-8 py-4 rounded-full bg-primary text-white font-bold text-lg shadow-xl shadow-primary/30 hover:bg-primary/90 transition-all">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4 md:gap-8 max-w-5xl mx-auto border-t border-border pt-10 mt-10">
            <Counter value={personal.yearsLearning} label="Years Learning" icon={GraduationCap} />
            <Counter value={personal.experienceYears} label="Years Experience" icon={Briefcase} />
            <Counter value={personal.domainsCount} label="Professional Domains" icon={Grid3X3} />
            <Counter value={personal.mbaStatus} label="In Progress" icon={BookOpenText} isStatic />
            <Counter value={personal.aiStatus} label="Building AI Solutions" icon={Sparkles} isStatic />
          </div>
        </motion.div>
      </Container>
